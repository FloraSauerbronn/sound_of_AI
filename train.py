...
############################################################################
    ...
    feed_forward_net = FeedFowardNet().to(device)#instantiate
...
torch.save(feed_forward_net.state_dict(),"feedfowardnet.pth")
...
print("Model Ttrained and stored at feedfowardnet.pth")